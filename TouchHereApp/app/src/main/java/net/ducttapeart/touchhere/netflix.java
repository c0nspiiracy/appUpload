...
public class netflix extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.app_activity_netflix);
    ...
    public void onClick(View view){
        ...
        if(isPackageInstalled("com.netflix.mediaclient", pm)) {
            Intent i;
            ...
            String url = "https://play.google.com/store/apps/details?id=com.netflix.mediaclient&hl=en";
