...
public class spotify extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.app_activity_spotify);
    }

    public void onClick(View view){
        PackageManager pm = this.getPackageManager();

        if(isPackageInstalled("com.spotify.music", pm)) {
            Intent i;
            ...
            String url = "https://play.google.com/store/apps/details?id=com.spotify.music&hl=en";
